...
object SkillGapTransformer extends CommonTransformer {
  ...
  override def getInsertFromSelectQuery(schema: String, ids: List[Long]): String = {
    ...
    s"""
       |INSERT INTO $schema.fact_skill_gap_tracker ($insCols)
       |SELECT $selCols
  ...
  override def getStagingTableName(): String = "staging_skill_gap_tracker"
