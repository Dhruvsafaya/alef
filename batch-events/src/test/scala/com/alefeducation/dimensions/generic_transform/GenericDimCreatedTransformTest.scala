...
class GenericDimCreatedTransformTest extends SparkSuite with BaseDimensionSpec {
  ...
  test("Should transform created event") {
    ...
    val transformer = new GenericDimCreatedTransform(sprk, service, "academic-calendar-transform")
