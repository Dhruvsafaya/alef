...
class GenericDimUpdatedTransformTest extends SparkSuite with BaseDimensionSpec {
  ...
  test("Should transform updated event") {
    ...
    val transformer = new GenericDimUpdatedTransform(sprk, service, "academic-calendar-transform")
